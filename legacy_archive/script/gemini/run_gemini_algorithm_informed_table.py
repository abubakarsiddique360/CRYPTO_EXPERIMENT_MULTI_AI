#!/usr/bin/env python3
"""GEMINI Algorithm Informed Table Runner

Reads the latest raw results from:
  data/results/gemini/algorithm_informed/raw_results/

Writes tables to:
  data/results/gemini/algorithm_informed/tables/
"""
...
def main():
    ...
    generator = TableGenerator(platform='gemini', condition='algorithm_informed')
